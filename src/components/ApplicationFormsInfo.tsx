...
export function ApplicationFormsInfo({ onGoBack }: { onGoBack: () => void }) {
    ...
    <div className="font-sans space-y-6 pb-6">
      ...
      >
        ...
        <div className="mt-6 relative z-10">
          <p className="text-[#4DB6AC] text-sm font-bold mb-2 uppercase tracking-wide">ডিজিটাল ফরম ব্যাংক</p>
          <h1 className="text-4xl font-black mb-3 text-white">সরকারি আবেদন ফরম</h1>
          <p className="text-white/90 text-sm md:text-base max-w-lg leading-relaxed border-l-4 border-[#4DB6AC]/50 pl-3 py-1">
             পুঠিয়া উপজেলা ও ইউনিয়ন পরিষদের বিভিন্ন সেবার অফলাইন ফরম। ডাউনলোড করে প্রিন্ট নিয়ে সহজেই ব্যবহার করুন।
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <span className="text-2xl">📄</span> ইউনিয়ন ফরম
        </button>
        <button 
        ...
        >
          <span className="text-2xl">📄</span> উপজেলা ফরম
        </button>
        <button 
        ...
        >
          <span className="text-2xl">🏢</span> ভূমি অফিস ফরম
        </button>
        <button 
        ...
        >
          <span className="text-2xl">🔍</span> সব ফরম তালিকা
        </button>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm flex flex-col hover:shadow-md transition relative overflow-hidden">
          ...
          <div className="flex gap-4 items-start pl-2">
            ...
            <div>
              <h4 className="font-serif font-black text-gray-900 text-xl leading-tight mb-1">উত্তরাধিকার/ওয়ারিশান সনদের আবেদন ফরম</h4>
              <p className="text-sm mt-1 text-gray-600 font-medium flex items-center gap-1.5"><FileText className="w-4 h-4 shrink-0 text-gray-400"/> PDF <span className="text-gray-300">|</span> ১.২ MB</p>
            </div>
          </div>
          ...
          <div className="mt-4 bg-[bg-teal-50] p-4 rounded-2xl border border-teal-100 ml-2">
             <p className="text-sm text-gray-700 font-sans leading-relaxed">
               ...
               ইউনিয়ন পরিষদ বা পৌরসভা থেকে ওয়ারিশ কায়েম সনদ পাওয়ার জন্য নির্ধারিত আবেদন ফরম।
             </p>
          </div>
          ...
          <div className="mt-5 pl-2">
            ...
            >
              <FileDown className="w-5 h-5" /> ডাউনলোড করুন (PDF)
            </a>
          </div>
        </div>
      </div>
