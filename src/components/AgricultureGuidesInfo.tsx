...
export function AgricultureGuidesInfo({ onGoBack }: { onGoBack: () => void }) {
    ...
    <div className="font-sans space-y-6 pb-6">
      ...
      >
        ...
        <div className="mt-6 relative z-10">
          <p className="text-[#4DB6AC] text-sm font-bold mb-2 uppercase tracking-wide">স্মার্ট কৃষি ও আধুনিক চাষাবাদ</p>
          <h1 className="text-4xl font-black mb-3 text-white">কৃষি ও খামার সহায়িকা</h1>
          <p className="text-white/90 text-sm md:text-base max-w-lg leading-relaxed border-l-4 border-[#4DB6AC]/50 pl-3 py-1">
             উপজেলা কৃষি সম্প্রসারণ অধিদপ্তর কর্তৃক অনুমোদিত আধুনিক চাষাবাদ পদ্ধতি ও ফসল রক্ষা নির্দেশিকা।
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <span className="text-2xl">🚜</span> ফসল চাষ গাইড
        </button>
        <button 
        ...
        >
          <span className="text-2xl">🐛</span> পোকা দমন নির্দেশিকা
        </button>
        <button 
        ...
        >
          <span className="text-2xl">🥭</span> আম চাষ ম্যানুয়াল
        </button>
        <button 
        ...
        >
          <span className="text-2xl">🐟</span> মৎস্য ও পশুপালন
        </button>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm flex flex-col hover:shadow-md transition relative overflow-hidden">
          ...
          <div className="flex gap-4 items-start pl-2">
            ...
            <div>
              <h4 className="font-serif font-black text-gray-900 text-xl leading-tight mb-1">পুঠিয়ার আম চাষ ও পোকা দমন ম্যানুয়াল</h4>
              <p className="text-sm mt-1 text-gray-600 font-medium flex items-center gap-1.5"><FileText className="w-4 h-4 shrink-0 text-gray-400"/> PDF <span className="text-gray-300">|</span> ৩.৫ MB</p>
            </div>
          </div>
          ...
          <div className="mt-4 bg-[bg-teal-50] p-4 rounded-2xl border border-teal-100 ml-2">
             <p className="text-sm text-gray-700 font-sans leading-relaxed">
               ...
               বানেশ্বর ও পুঠিয়া অঞ্চলের আম চাষীদের জন্য মুকুল আসা থেকে শুরু করে ফল সংগ্রহ পর্যন্ত আধুনিক ও বৈজ্ঞানিক পরিচর্যা গাইড।
             </p>
          </div>
          ...
          <div className="mt-5 pl-2">
            ...
            >
              <FileDown className="w-5 h-5" /> গাইড ডাউনলোড (PDF)
            </a>
          </div>
        </div>
      </div>
