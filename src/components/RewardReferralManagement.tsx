...
export default function RewardReferralManagement() {
    ...
    const handleSave = () => {
        ...
        setTimeout(() => {
            setIsSaving(false);
            setSuccessMessage('রেফারেল সেটিংস সফলভাবে সেভ করা হয়েছে।');
    ...
    return (
        <div className="bg-[#1E1E1E] border border-gray-800 rounded-2xl p-6">
            <h3 className="text-xl font-bold text-white mb-6 pb-6 border-b border-gray-800 flex items-center gap-2">
                ...
                <span>রেফারেল বোনাস সেটিংস</span>
            </h3>
            
            <div className="space-y-6 max-w-2xl">
                <div className="bg-[#2A2A2A] border border-gray-800 rounded-xl p-6">
                    <p className="text-gray-400 text-sm mb-6">
                        ইউজাররা যখন তাদের রেফারেল কোড দিয়ে নতুন ইউজারকে ইনভাইট করবে, তখন কে কত কয়েন পাবে তা এখান থেকে সেট করুন।
                    </p>

                    <div className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-400 mb-2">রেফারার বোনাস (যে ইনভাইট করেছে)</label>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-400 mb-2">রেফারি বোনাস (যে জয়েন করেছে)</label>
                            <div className="relative">
                                <input
                                    type="number"
                                    value={refereeBonus || ""}
