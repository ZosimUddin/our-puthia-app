...
export function OcContactInfo({ onGoBack }: { onGoBack: () => void }) {
  ...
  return (
    <div className="font-sans space-y-6 pb-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <span className="text-2xl">🚓</span> ওসি (ব্যক্তিগত)
        </button>
        <button
        ...
        >
          <span className="text-2xl">☎️</span> থানা ডিউটি অফিসার
        </button>
        <button
        ...
        >
          <span className="text-2xl">🚔</span> পুঠিয়া সার্কেল SP
        </button>
        <button
        ...
        >
          <span className="text-2xl">🚨</span> জরুরি কন্ট্রোল রুম
        </button>
      </div>
        ...
        <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm flex flex-col hover:shadow-md transition relative overflow-hidden">
          ...
          <div className="flex gap-4 items-start pl-2">
            ...
            <div>
              <h4 className="font-serif font-black text-gray-900 text-xl leading-tight mb-1">
                অফিসার ইনচার্জ (OC) - পুঠিয়া থানা
              </h4>
              <p className="text-sm mt-1 text-gray-600 font-medium flex items-center gap-1.5">
                <Building className="w-4 h-4 shrink-0 text-gray-400" /> পুঠিয়া
                থানা, রাজশাহী জেলা পুলিশ
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 bg-[bg-red-50] p-4 rounded-2xl border border-red-100 ml-2">
            <p className="text-sm text-gray-700 font-sans leading-relaxed flex items-start gap-2">
              ...
              <span>
                <span className="font-bold text-[#D32F2F]">নোট:</span> যেকোনো
                অপরাধমূলক কর্মকাণ্ডের তথ্য দিতে সরাসরি যোগাযোগ করুন।
              </span>
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 mt-5 pl-2">
            <button
              onClick={() => onSimulateAction("Calling OC")}
            ...
            >
              <Phone className="w-5 h-5" /> ওসিকে কল করুন
            </button>
            <button
              onClick={() => onSimulateAction("Calling Duty Officer")}
            ...
            >
              <Phone className="w-5 h-5" /> ডিউটি অফিসার (২৪ ঘণ্টা)
            </button>
          </div>
        </div>
      </div>
