...
export default function RevenueSubscriptionManagement() {
    const [plans, setPlans] = useState<SubscriptionPlan[]>([
        {
            ...
            features: ['Ad-free experience', 'Unlimited listings', 'Basic analytics'],
            isActive: true
        },
        {
            id: '2',
    ...
    const handleSave = () => {
        ...
        setTimeout(() => {
            setIsSaving(false);
            setSuccessMessage('সাবস্ক্রিপশন সেটিংস সেভ করা হয়েছে।');
                    ...
                    <div key={plan.id} className="bg-[#2A2A2A] border border-gray-800 rounded-xl p-6 relative">
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                ...
                                <div className="text-2xl font-bold text-emerald-500">{plan.price}<span className="text-sm font-normal text-gray-400">/{plan.billingCycle}</span></div>
                            </div>
