...
export default function LocationNearbyManagement() {
    ...
    const handleSave = () => {
        ...
        setTimeout(() => {
            setIsSaving(false);
            setSuccessMessage('নিয়ারবাই সার্ভিস সেটিংস সেভ করা হয়েছে।');
        ...
        <div className="bg-[#1E1E1E] border border-gray-800 rounded-2xl p-6">
            ...
            <div className="space-y-6 max-w-2xl">
                <div className="flex items-center justify-between p-4 bg-[#2A2A2A] border border-gray-800 rounded-xl">
                    <div>
                        <h4 className="text-white font-medium">Enable Nearby Services</h4>
                        <p className="text-sm text-gray-400">Enable or disable nearby services discovery</p>
                    </div>
